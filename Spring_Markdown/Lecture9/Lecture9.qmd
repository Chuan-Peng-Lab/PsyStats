...
-   用样本标准差S\_{n-1}作为总体参数$\sigma$的估计值

-   标准误$SE = \frac{s_{n-1}}{\sqrt{n}}$

$$P(\bar{X}-Z_{\frac{\alpha}{2}}\frac{s_{n-1}}{\sqrt{n}}<\mu<\bar{X}+Z_{\frac{\alpha}{2}}\frac{s_{n-1}}{\sqrt{n}})=1-\alpha$$ \## 总体非正态分布，总体方差已知
...
<center>从某小学三年级随机抽取12名学生，其阅读能力得分为28，32，36，22，34，30，33，25，31，33，29，26。假定小学三年级学生的阅读能力是正态分布，试估计该校三年级学生阅读能力总体平均数95％和99％的置信区间。</center>
...
-   设随机变量\$X \sim \chi\_m\^2,Y \sim \chi\_n\^2,且X与Y独立，则称
...
-   $X \sim F(n_1,n_2), \frac{1}{X} ~ F(n_2, n_1)$

-   $X \sim t(n), X \sim F(1,n)$
