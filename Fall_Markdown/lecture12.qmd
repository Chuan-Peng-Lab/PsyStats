...
![](images/1700805337187.jpg)

## 

-   因素分析的代数模型：

![](images/1700805435888.jpg)
...
```{r echo=TRUE}
EFA(df, varrange=c("BFI_A1:BFI_E8"),# 选取观测变量
    nfactors="parallel", #决定抽取多少因子
    method="minres",# 因子提取方法,最小残差因子分析       
    rotation="varimax", # 旋转方法，方差最大化
...
![](images/1701056253249.jpg)

# Part 2: 主成分分析(PCA)

## 

![](images/1700810365953.jpg)
...
![](images/1701056390059.jpg)

## 

![](images/1700811217292.jpg)
...
![](images/1700881403678.jpg)

https://zhuanlan.zhihu.com/p/37856153

## 

![](images/1700881449626.jpg)
