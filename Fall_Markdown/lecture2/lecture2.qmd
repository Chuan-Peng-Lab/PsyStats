...
## 对*F*检验和*t*检验的模拟
<br>
第一步：从$N(100, 15)$的正态分布中抽取三个$n = 30$的样本；
...
# 求第一组的均值
m1 <- mean(data$variable[data$region == 1 & data$gender == 1])

# 求第一组的SD
SS1 <- var(data$variable[data$region == 1 & data$gender == 1]) * 10
