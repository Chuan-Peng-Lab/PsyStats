...
-   预测项: $\hat{salary_{i,j}}=\beta_0+\beta_1x_{i,j}$
...
-   $\beta_{0,j}=\beta_0+effect_{group} = \beta_0+\mu_j,\mu_j \sim N(0,\sigma_j)$
...
-   $\beta_{1,j}=\beta_1+effect_{group} = \beta_1+\mu_j,\mu_j \sim N(0,\sigma_j)$

    -   $\beta_1$:总体(学校)工龄对员工工资影响的平均值
    -   $\mu_j$:组(学院)工龄对员工工资影响的平均值与总体(学校)平均值的差值
